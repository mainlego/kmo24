      ...
      <Transition name="modal-fade">
        <div v-if="isSearchOpen" class="search-modal" @click.self="closeSearchModal">
          <div class="search-modal__content" @click.stop>
            ...
            <SmartSearch :auto-open="true" @close="closeSearchModal" />
          </div>
        </div>
      </Transition>
    </Teleport>
      ...
      <div class="container">
            ...
            <div class="footer-section">
              ...
              <ul class="footer-contacts">
                <li>
                  ...
                  <div>
                    <div>+7 (902) 923-97-04</div>
                    <div>+7 (967) 612-35-64</div>
                  </div>
                </li>
                <li>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
        ...
        <div class="footer-bottom">
          <p class="footer-copyright">
            &copy; {{ new Date().getFullYear() }} КМО24 - ИП Нижник Виталий Робертович. Все права защищены.
          </p>
