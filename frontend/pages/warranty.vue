        ...
        <div class="warranty-card contact-card">
          ...
          <div class="contact-buttons">
            <a href="tel:+73919892013" class="btn-primary">
              ...
              <AdminEditableElement
                element-id="warranty-btn-call"
                tag="span"
                type="text"
                label="Кнопка Позвонить"
                :default-value="'Позвонить'"
              >
                {{ pageEditor.getElementValue('warranty-btn-call', 'Позвонить') }}
              </AdminEditableElement>
            </a>
            <NuxtLink to="/contacts" class="btn-secondary">
              <svg viewBox="0 0 24 24" fill="none">
              ...
              <AdminEditableElement
                element-id="warranty-btn-contacts"
                tag="span"
                type="text"
                label="Кнопка Контакты"
                :default-value="'Контакты'"
              >
                {{ pageEditor.getElementValue('warranty-btn-contacts', 'Контакты') }}
              </AdminEditableElement>
            </NuxtLink>
          </div>
        </div>
...
.warranty-card {
  ...
  &.main-card {
    background: linear-gradient(135deg, $white 0%, rgba($primary-50, 0.5) 100%);
...
.section-title {
  ...
  &::after {
    ...
    flex: 1;
    height: 2px;
    background: linear-gradient(90deg, $gray-200 0%, transparent 100%);
