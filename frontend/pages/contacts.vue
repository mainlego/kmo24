        ...
        <div class="header-content">
          <div class="header-text">
            <AdminEditableElement
              element-id="contacts-title"
              tag="h1"
              type="text"
              label="Заголовок страницы"
              class="page-title"
              default-value="Контакты"
            >
              {{ pageEditor.getElementValue('contacts-title', 'Контакты') }}
            </AdminEditableElement>
            <AdminEditableElement
              element-id="contacts-subtitle"
              tag="p"
              type="text"
              label="Подзаголовок"
              class="page-subtitle"
              default-value="Свяжитесь с нами для консультации"
            >
              {{ pageEditor.getElementValue('contacts-subtitle', 'Свяжитесь с нами для консультации') }}
            </AdminEditableElement>
          </div>
          <button class="callback-btn" @click="isCallbackModalOpen = true">
      ...
      <div class="container">
        <div class="map-section">
          <div class="map-header">
            <AdminEditableElement
              element-id="contacts-map-title"
              tag="h2"
              type="text"
              label="Заголовок карты"
              class="map-title"
              default-value="Мы на карте"
            >
              {{ pageEditor.getElementValue('contacts-map-title', 'Мы на карте') }}
            </AdminEditableElement>
        ...
        <div class="contacts-grid">
          ...
          <div class="contact-form-wrapper">
            <div class="form-header">
              <AdminEditableElement
                element-id="contacts-form-title"
                tag="h2"
                type="text"
              ...
              >
                {{ pageEditor.getElementValue('contacts-form-title', 'Напишите нам') }}
              </AdminEditableElement>
              <AdminEditableElement
                element-id="contacts-form-subtitle"
                tag="p"
                type="text"
                label="Подзаголовок формы"
                class="form-subtitle"
                default-value="Ответим в течение 1 часа в рабочее время"
              >
                {{ pageEditor.getElementValue('contacts-form-subtitle', 'Ответим в течение 1 часа в рабочее время') }}
              </AdminEditableElement>
            </div>
          ...
          <div class="contact-info">
            ...
            <div class="social-links">
              <a href="https://t.me/kmo24" class="social-link" aria-label="Telegram" target="_blank" rel="noopener noreferrer">
