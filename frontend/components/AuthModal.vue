        ...
        <div class="auth-modal" @click.stop>
          ...
          <form v-if="activeTab === 'login'" @submit.prevent="handleLogin" class="auth-form">
            ...
            <div class="social-buttons">
              ...
              <button type="button" class="social-btn" @click="handleYandexLogin">
                <svg width="20" height="20" viewBox="0 0 24 24">
                  <path fill="#ff0000" d="M12 0C5.37 0 0 5.37 0 12s5.37 12 12 12 12-5.37 12-12S18.63 0 12 0zm2.44 18h-1.93v-6.06c0-.08-.01-.16-.02-.24L9.43 18H7.89l-3.31-6.69c-.03.15-.05.3-.05.45V18H2.98V6h1.93l3.6 7.29L12.05 6h1.93v9.54h.46V18z"/>
                </svg>
                Яндекс
              </button>
            </div>
...
const handleGoogleLogin = () => {
  ...
  message.value = 'Google авторизация будет добавлена в ближайшее время';
  messageType.value = 'error';
};

const handleYandexLogin = () => {
  // TODO: Implement Yandex OAuth
  message.value = 'Яндекс авторизация будет добавлена в ближайшее время';
  messageType.value = 'error';
};
</script>
